...
*/
// 1ª Criar duas funções;
// 2ª Recebem dois parametros;
// 3ª A primeira função deve retornar o resultado da multiplicação elemento dos vetores
// 4ª A segunda função somente irá multiplicar se for maior que 5

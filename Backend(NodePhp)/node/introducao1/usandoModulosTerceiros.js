//Instalando biblioteca de terceiros
/*
    Biblioteca de exemplo lodash

    resumo sobre a biblioteca:
...
setInterval(() =>{
    console.log(_.random(50, 60)) //chamada da função _.random da biblioteca lodash
}, 2000)